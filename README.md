...
| Image                                                     | Description                            |
| --------------------------------------------------------- | -------------------------------------- |
| [OS Base](https://github.com/nfrastack/container-alpine/) | Customized Image based on Alpine Linux |
...
| `CONFIG_PATH`                | Folder for Config Files                                                         | `${DATA_PATH}/config/`      |          |
| `DEFINITIONS_PATH`           | Folder for Virus Definitions                                                    | `${DATA_PATH}/definitions/` |          |
